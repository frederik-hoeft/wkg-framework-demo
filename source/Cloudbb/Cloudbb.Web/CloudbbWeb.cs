...
internal sealed class CloudbbWeb() : DeploymentVersionInfo(CI_DEPLOYMENT__VERSION_PREFIX, CI_DEPLOYMENT__VERSION_SUFFIX, CI_DEPLOYMENT__DATETIME_UTC)
{
    ...
    /// </summary>
    public static CloudbbWeb VersionInfo { get; } = new CloudbbWeb();
}
