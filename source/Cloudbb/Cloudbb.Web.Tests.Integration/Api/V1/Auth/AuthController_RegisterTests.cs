...
public sealed class AuthController_RegisterTests : ControllerBaseTest<AuthController>
{
    ...
    [TestMethod]
    public Task RegisterAsync_WithValidData_ShouldSucceedAsync()
    {
        // Arrange
    ...
    [TestMethod]
    public Task RegisterAsync_WithDuplicateEmail_ShouldReturnBadRequestAsync()
    {
        // Arrange
        string duplicateEmail = "MyTestUser@example.com";
        ...
        RegisterRequest secondRequest = new()
        {
        ...
        return UsingControllerAsync(firstRequest, async (controller, serviceProvider, ct) =>
        {
            // First registration should succeed
            IActionResult firstResult = await controller.RegisterAsync(firstRequest, ct);
            Assert.IsInstanceOfType<OkObjectResult>(firstResult);

            // Act - Second registration with same email should fail
            IActionResult result = await controller.RegisterAsync(secondRequest, ct);
    ...
    [TestMethod]
    public Task RegisterAsync_WithDuplicateUsername_ShouldReturnBadRequestAsync()
    {
        // Arrange
    ...
    [TestMethod]
    public Task RegisterAsync_WithMismatchedPasswords_ShouldReturnBadRequestAsync()
    {
        // Arrange
        RegisterRequest request = new()
        {
    ...
    [TestMethod]
    public Task RegisterAsync_WithWeakPassword_ShouldReturnBadRequestAsync()
    {
        // Arrange
        RegisterRequest request = new()
        {
    ...
    [TestMethod]
    public Task RegisterAsync_WithInvalidEmail_ShouldReturnBadRequestAsync()
    {
        // Arrange
        RegisterRequest request = new()
        {
    ...
    [TestMethod]
    public Task RegisterAsync_WithEmptyFields_ShouldReturnBadRequestAsync()
    {
        // Arrange
        RegisterRequest request = new()
        {
