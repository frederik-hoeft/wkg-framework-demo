...
namespace Cloudbb.Client;

internal sealed class CloudbbClient() : DeploymentVersionInfo(CI_DEPLOYMENT__VERSION_PREFIX, CI_DEPLOYMENT__VERSION_SUFFIX, CI_DEPLOYMENT__DATETIME_UTC)
{
    ...
    /// </summary>
    public static CloudbbClient VersionInfo { get; } = new CloudbbClient();
}
